...
public class Vendedor_Cliente extends DBHelperController {
	private final String TABLE_NAME = "Vendedor_Cliente";
	public static final String idVendedor = "idVendedor";
	private static final String idCliente = "idCliente";
	private Context context;

	public Vendedor_Cliente(Context context) {
		this.context = context;
	}

	public void insert(String idVendedor, String idCliente) {
		idVendedor = idVendedor != null ? "\"" + idVendedor + "\"" : null;
		idCliente = idCliente != null ? "\"" + idCliente + "\"" : null;
		
		Object[] values_ar = {idVendedor, idCliente};
		String[] fields_ar = {Vendedor_Cliente.idVendedor, Vendedor_Cliente.idCliente};
